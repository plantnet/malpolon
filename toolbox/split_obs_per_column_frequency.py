...
def main(input_path: str,
    ...
    # Compute the number of classes which do not have enough occurrences to be split
    ...
    for sid, n_sid in zip(tqdm(u_cls_sorted_desc[0]), u_cls_sorted_desc[1]):
        # Rare occurrences are excluded from the val split and kept in train
...
if __name__ == '__main__':
    ...
    main(args.input_path[0], args.output_name[0],
         filter_id=args.filter_id[0], sep=args.sep[0])
