...
from ..models.standard_classification_models import StandardFinetuningClassificationSystem
...
def main(cls: DictConfig):
    ...
    datamodule = MiniGeoLifeCLEF22DataModule.from_argparse_args(Namespace(**cls.data))
