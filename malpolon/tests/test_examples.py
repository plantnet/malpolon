...
KAGGLE_EXAMPLE_PATHS = {'geolifeclef2022': [Path('examples/kaggle/geolifeclef2022/cnn_on_rgb_patches.py'),
                                            Path('examples/kaggle/geolifeclef2022/cnn_on_rgb_temperature_patches.py'),
                                            Path('examples/kaggle/geolifeclef2022/cnn_on_temperature_patches.py')],
                        'geolifeclef2023': [Path('examples/kaggle/geolifeclef2023/cnn_on_rgbnir_glc23_patches.py'),
                                            Path('examples/kaggle/geolifeclef2023/example_patch_loading.py'),
                                            Path('examples/kaggle/geolifeclef2023/example_time_series_loading.py')]}
