...
from malpolon.data.datasets.geolifeclef2023 import MultipleRasterPatchProvider, RasterPatchProvider, JpegPatchProvider
from malpolon.data.datasets.geolifeclef2023 import PatchesDataset, PatchesDatasetMultiLabel
...
def main():
    ...
    p_rgb = JpegPatchProvider(data_path + 'SatelliteImages/',
                              dataset_stats='jpeg_patches_sample_stats.csv')  # take all sentinel imagery layer (r,g,b,nir)
