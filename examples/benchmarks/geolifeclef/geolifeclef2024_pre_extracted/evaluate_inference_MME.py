...
df_preds = pd.read_csv('outputs/glc24_cnn_multimodal_ensemble/2025-10-15_17-27-40_prediction_with_jrc_sat_KoLeo_wandbid-ysg61d9y/predictions_test_dataset.csv', sep=';')
