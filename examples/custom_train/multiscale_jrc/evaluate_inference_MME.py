...
# 0. Load data
df_gt = pd.read_csv('outputs/inference/Downstream satellite img GLC24 IMAGENET pretraining/predictions_all.csv')  # dataset/scale_3_satellite/geolifeclef-2024/GLC24_SOLUTION_FILE.csv')
df_preds = pd.read_csv('outputs/inference/Downstream satellite img GLC24 IMAGENET pretraining/predictions_all.csv')
